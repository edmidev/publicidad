        ...
        <div class="row px-4">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title">Lista de terapias</h4>
                    <button type="button" class="btn btn-success" @click="selectItem()">Crear terapia</button>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-5 col-lg-4 col-xl-3 pe-2 mb-1">
                                <div>
                                    ...
                                    <input type="text" class="form-control" placeholder="Buscar terapia"
...
const fetchData = async (url = 'therapies/search') => {
...
const selectItem = (item = null) => {
    ...
    $('#terapy-form-modal').modal('show')
}

const toggleRegister = async (item) => {
    const loader = $loading.show()
    try {
        const response = await axios.post('therapies/toggle/' + item.id)
        const data = response.data
