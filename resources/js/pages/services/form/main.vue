<template>
    <!-- Modal -->
    <div id="service-form-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="service-form-modalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-success">
                    <h4 class="modal-title" id="service-form-modalLabel">{{ (props.item ? 'Editar' : 'Crear') }} servicio</h4>
