    ...
    <div class="col-xxl-8 col-lg-10">
                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="auth-brand p-4">
                            ...
                            <a href="index.html" class="logo-dark">
                                <img src="@/assets/images/dr_ozono.svg" alt="dark logo" height="22">
                            </a>
                        </div>
                        <div class="p-4">
                            <h4 class="fs-20">Restaurar contraseña</h4>
                            <p class="text-muted mb-3">
                                Ingrese su dirección de correo electrónico para iniciar el proceso de restablecimiento de contraseña.
                            </p>
                            <!-- form -->
                            <section>
                                <div class="mb-3">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <p class="text-dark-emphasis">¿Tienes una cuenta?
